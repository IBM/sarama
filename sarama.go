...
Broker related metrics:
	...
	|                                                    |            | for a given broker                                            |
	| protocol-requests-<api-key>          	             | counter    | Number of api requests sent to the brokers for all brokers    |
	|                                                    |            | https://kafka.apache.org/protocol.html#protocol_api_keys      |                                        |
	| protocol-requests-<api-key>-for-broker-<broker-id> | counter    | Number of packets sent to the brokers by api-key for a given  |
	|                                                    |            | broker                                                        |
	+----------------------------------------------------+------------+---------------------------------------------------------------+
