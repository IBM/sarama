	...
	tests := []test{
		...
		},
		{
			...
			map[int16]int16{
				...
				apiKeyProduce:            9, // up from 8 (flexible)
			},
		},
		{
			V3_1_0_0,
		...
		},
		{
			V3_6_0_0,
			map[int16]int16{
				apiKeyAddPartitionsToTxn: 4, // up from 3 (KIP-890 part 1, batched form)
			},
		},
		{
			V3_7_0_0,
			map[int16]int16{
				apiKeyProduce: 10, // up from 9 (KIP-951)
			},
		},
		{
			V3_8_0_0,
			map[int16]int16{
				apiKeyEndTxn:             4,  // up from 3 (KIP-890 TRANSACTION_ABORTABLE)
				apiKeyTxnOffsetCommit:    4,  // up from 3 (KIP-890 TRANSACTION_ABORTABLE)
				apiKeyInitProducerId:     5,  // up from 4 (KIP-890)
				apiKeyAddPartitionsToTxn: 5,  // up from 4 (KIP-890)
				apiKeyProduce:            11, // up from 10 (KIP-890)
			},
		},
		{
			V4_0_0_0,
			map[int16]int16{
				...
				apiKeyProduce:         12, // up from 11 (KIP-890 transactions v2)
			},
		},
		{
